package com.example.SpringRedis_pet10.Config;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .oauth2Login(oauth2 -> oauth2
                        .defaultSuccessUrl("/flower/main", true) // Перенаправление после успешного входа через OAuth2
                )
                .formLogin(form -> form
                        .loginPage("/visitor/login") // Указываем страницу входа
                        .loginProcessingUrl("/process_login") // URL для обработки входа
                        .defaultSuccessUrl("/flower/main", true) // Перенаправление после успешного входа через форму
                        .permitAll()
                )
